...
ssh dckreg mkdir -p /var/tmp/hbase-base
scp hbase-base/* dckreg:/var/tmp/hbase-base
ssh dckreg "export HADOOP_VERSION=$HADOOP_VERSION; export HBASE_VERSION=$HBASE_VERSION;export PHOENIX_VERSION=$PHOENIX_VERSION;cd /var/tmp/hbase-base;./build.sh"
...
ssh dckreg mkdir -p /var/tmp/spark-base
scp spark-base/* dckreg:/var/tmp/spark-base
ssh dckreg "export HBASE_VERSION=$HBASE_VERSION; export SPARK_VERSION=$SPARK_VERSION; export SPARK_BIN_VERSION=$SPARK_BIN_VERSION; export SBT_VERSION=$SBT_VERSION; cd /var/tmp/spark-base;./build.sh"
